        ...
        <div class="content-wrapper">
                ...
                <div class="col-md-12 grid-margin">
                    <div class="row">
                        <div class="col-12 col-xl-8 mb-4 mb-xl-0">
                            <h3 class="font-weight-bold">Welcome Akastra Friends!</h3>
                            ...
                            <div class="justify-content-end d-flex">
                                <div class="dropdown flex-md-grow-1 flex-xl-grow-0">
                                    <button class="btn btn-sm btn-light bg-white dropdown-toggle" type="button"
                                        ...
                                        aria-expanded="true">
                                        <i class="mdi mdi-calendar"></i> Today (23 August 2022)
                                    </button>
                ...
                <div class="col-md-6 grid-margin stretch-card">
                    <div class="card tale-bg">
                        <div class="card-people mt-auto">
                            <img src="/assets/images/dashboard/people.png" alt="people">
                            <div class="weather-info">
                                <div class="d-flex">
                                    ...
                                    <div class="ml-4">
                                        <h4 class="location font-weight-normal">South Jakarta</h4>
                    ...
                    <div class="row">
                        <div class="col-md-6 mb-4 stretch-card transparent">
                            <div class="card card-tale">
                                <div class="card-body">
                                    <p class="mb-4">Jumlah PKB</p>
                                    <p class="fs-30 mb-2">120 PKB</p>
                                    <p>90 Days</p>
                                </div>
                            </div>
                        </div>
                        <div class="col-md-6 mb-4 stretch-card transparent">
                            <div class="card card-dark-blue">
                                <div class="card-body">
                                    ...
                                    <p class="fs-30 mb-2">90 Customer</p>
                                    <p>90 Days</p>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="row">
                        <div class="col-md-6 mb-4 mb-lg-0 stretch-card transparent">
                            <div class="card card-light-blue">
                                <div class="card-body">
                                    <p class="mb-4">Kredit</p>
                                    <p class="fs-30 mb-2">Rp. 100.000.000</p>
                                    <p>30 Days</p>
                                </div>
                            </div>
                        </div>
                        <div class="col-md-6 stretch-card transparent">
                            <div class="card card-light-danger">
                                <div class="card-body">
                                    <p class="mb-4">Debit</p>
                                    <p class="fs-30 mb-2">Rp. 260.000.000</p>
                                    <p>30 Days</p>
                                </div>
                            </div>
                        </div>
            ...
            <div class="row">
                <div class="col-md-6 grid-margin stretch-card">
                    <div class="card">
                        <div class="card-body">
                            <p class="card-title">Debit Details</p>
                            <p class="font-weight-500 mb-5">
                                The total number of sessions within the date range. It
                                is the debit was engaged with cashflow
                                etc
                            </p>
